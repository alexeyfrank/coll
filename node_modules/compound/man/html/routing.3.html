...
<dt><code>subdomain</code></dt><dd><p>Check HOST header when matching request, use * as wildcard domain:</p>
...
<p><em>NOTE</em>: This feature relies on <code>host</code> header, if your node process behind nginx
or proxy, make sure you've passed this header to process.</p>
